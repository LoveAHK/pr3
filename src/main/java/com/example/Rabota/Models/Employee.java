...
public class Employee {
    ...
    @Past(message = "Дата не может быть будующей")
    private java.util.Date birthday;
    @Min(0)
    @NotNull(message = "Заполните поле стажа")
    ...
    public Integer getExpetienxs() {return expetienxs;}

    public void setExpetienxs(Integer expetienxs) {this.expetienxs = expetienxs;}
