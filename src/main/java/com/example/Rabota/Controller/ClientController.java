...
public class ClientController {
    ...
    public String blogPostAdd(@Valid Client client, BindingResult bindingResult, Model model)
    {
    ...
    {
        List<Client> clients = clientRepository.findByLastnameContains(lastname);
        model.addAttribute("result", clients);
        return "Search-Client";
    }
    ...
    public String blogClientDelete(
